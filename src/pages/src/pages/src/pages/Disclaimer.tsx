  ...
  return (
    <div className="min-h-screen bg-[#0f0f12] text-white py-20 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-gray-300 mb-4">This website contains advertisements provided by third-party advertising networks. We are not responsible for the content of these advertisements.</p>
