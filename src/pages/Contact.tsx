          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-white/5 border border-gray-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-yellow-500"
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-white/5 border border-gray-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-yellow-500 resize-none"
                placeholder="Your message..."
              />
            </div>
            <button
              type="submit"
              className="w-full bg-yellow-500 hover:bg-yellow-600 text-black font-bold py-3 rounded-lg flex items-center justify-center gap-2 transition-colors"
            >
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3 text-gray-300">
              ...
              <span>khabarblast24@gmail.com</span>
            </div>
            <div className="flex items-center gap-3 text-gray-300">
